"""Skill file generator for Agent Skills standard (agentskills.io)."""
...
INSTRUCTIONS = r"""You are managing project requirements and design decisions using the `rcli` CLI tool.
...
def generate_skill_content() -> str:
    """Return the SKILL.md content following the Agent Skills standard."""
    return (FRONTMATTER + "\n" + INSTRUCTIONS).strip() + "\n"
